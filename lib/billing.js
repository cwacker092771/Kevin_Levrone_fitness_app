...
function requireBillingInProduction() {
  if (!billingConfigured && process.env.NODE_ENV === "production") {
    throw new Error("STRIPE_SECRET_KEY / STRIPE_PUBLISHABLE_KEY must be set in production");
  }
}
